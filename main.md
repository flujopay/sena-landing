...
Cobrar es una de las partes mas dificiles de operar un negocio B2B. Las empresas enfrentan:

- Facturas desorganizadas y sin seguimiento
- Recordatorios manuales que se olvidan o llegan tarde
- Falta de visibilidad sobre el estado real de la cartera
- Casos complejos de mora que necesitan intervencion humana especializada
- Comunicacion fragmentada por multiples canales sin historial centralizado

Sena resuelve todo esto con una plataforma que centraliza la operacion de cobranza y, cuando la automatizacion no basta, entra un equipo humano experto respaldado por 40+ anos de experiencia.

---

## Respaldo: Recsa

Sena esta respaldada por **Recsa**, una empresa con:

- **Mas de 40 anos de experiencia** en cobranza
- **Presencia en 15 paises** de Latinoamerica
- **Mas de 146 millones de gestiones mensuales**

Ese conocimiento es lo que alimenta la plataforma y el equipo humano de Sena.

---

## Los dos productos principales

### 1. Plataforma de Autogestion

**Para el dia a dia de tu cobranza.**

Organiza facturas, automatiza recordatorios y controla todo tu ciclo de cobranza desde un solo lugar.

- Gestion diaria sin planillas ni sistemas paralelos
- Recordatorios automaticos por WhatsApp, email y SMS
- Control completo del ciclo de pago

---

### 2. Servicio de Recupero con Equipo Humano

**Recupera pagos con apoyo experto.**

Combina tecnologia y un equipo especializado para gestionar casos complejos y mejorar tu tasa de recuperacion.

- Equipo humano de Recsa interviene en casos dificiles
...
## Como funciona: 5 pasos para transformar tu cobranza
...
- 100+ clientes
- Desde 500 facturas/mes
- Todo lo de Growth, mas:
- Volumen ilimitado
- Integracion con Recsa
- Gestion humana especializada
...
Sena tiene landings especificas para las siguientes industrias:
...
- Facebook: facebook.com/sena.latam
- Instagram: instagram.com/sena.latam
- LinkedIn: linkedin.com/company/sena-latam
- YouTube: youtube.com/@flujolink
