  ...
  const pillars = [
    {
      title: 'Centraliza',
      description:
        'Todas tus cuentas por cobrar B2B en un solo lugar. Visibilidad por cliente, contrato, servicio, período de facturación o SLA, sin depender de Excel ni sistemas aislados.',
      icon: (
    ...
    },
    {
      title: 'Automatiza',
      description:
        'Secuencias de cobranza profesionales y configurables según tipo de cliente y contrato. Recordatorios formales, seguimientos operativos y escalamientos con el tono y timing adecuados.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      title: 'Recupera',
      description:
        'Para facturas críticas o clientes estratégicos, el equipo de especialistas interviene con experiencia en recuperación B2B corporativa y negociación compleja.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <section className="bg-[#F9F9F9] py-16 md:py-24">
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        ...
        <p className="text-slate-600 text-base md:text-lg max-w-2xl mb-12 leading-relaxed">
          Una plataforma diseñada para la cobranza B2B compleja en empresas de servicios básicos:
