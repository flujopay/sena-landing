export const ServiciosSocialProof = () => {
  const clientTypes = [
    'Empresas eléctricas',
    'Sanitarias',
    'Gas',
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-slate-700 text-base md:text-lg leading-relaxed italic">
                Gestionábamos contratos B2B de servicios básicos con pagos atrasados por validaciones
                operativas. Con Sena ordenamos la cobranza y recuperamos el 40% de la cartera vencida sin
                afectar contratos ni relaciones estratégicas.
              </p>
              <div className="mt-4">
                <p className="text-brand-primary-dark font-bold text-sm">Gerente de Finanzas</p>
                <p className="text-slate-500 text-sm">Empresa de Servicios Básicos</p>
              </div>
            </div>
          </div>
        </div>
