export const ServiciosSocialProof = () => {
  const clientTypes = ["Empresas eléctricas", "Sanitarias", "Gas", "Utilities", "Gestión de residuos", "Infraestructura crítica", "Servicios industriales"];
  const metrics = [
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        <div className="text-left mb-12">
          <p className="text-brand-primary-dark text-2xl sm:text-4xl font-extrabold leading-tight">
            Empresas de servicios básicos<br />
        ...
        <div className="bg-white rounded-2xl p-6 md:p-10 mb-12 border border-slate-100">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-slate-700 text-base md:text-lg leading-relaxed italic">Gestionábamos contratos B2B de servicios básicos con pagos atrasados por validaciones operativas. Con Sena ordenamos la cobranza y recuperamos el 40% de la cartera vencida sin afectar contratos ni relaciones estratégicas.</p>
              <div className="mt-4">
