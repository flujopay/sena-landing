export const ServiciosWhySena = () => {
  const differentiators = [
    { title: "Entendemos la cobranza B2B compleja en servicios básicos", description: "Conocemos los ciclos de pago, las validaciones operativas y la dinámica de contratos regulados del sector utilities." },
    { title: "Experiencia comprobada en industrias críticas y reguladas", description: "Respaldados por Recsa, con más de 40 años de trayectoria en cobranza corporativa y presencia en 15 países de Latinoamérica." },
    { title: "Tecnología escalable combinada con criterio humano experto", description: "Automatización inteligente para el volumen, intervención humana especializada para los casos que requieren negociación y sensibilidad comercial." },
  ];
