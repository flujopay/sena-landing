      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10 py-16 md:py-24">
        <div className="hidden md:flex flex-col gap-6 max-w-3xl">
          ...
          <p className="font-adobe text-black text-xl max-w-2xl leading-relaxed">
            En las <strong>empresas de servicios básicos</strong>, cada factura depende de contratos
            complejos, mediciones, validaciones operativas, regulaciones y procesos internos del cliente. Sena
            ordena y acelera tu ciclo de cuentas por cobrar B2B sin tensionar relaciones estratégicas.
          </p>
          <div className="flex flex-row items-start gap-3 mt-2">
            ...
            <Button
              ...
              className="text-lg"
              onClick={() => {
                const el = document.getElementById('serv-como-funciona')
                if (el) el.scrollIntoView({ behavior: 'smooth', block: 'start' })
              }}
            />
          </div>
          <p className="text-slate-500 text-sm mt-2">
            Empresas de servicios básicos y utilities B2B ya confían en Sena.
          </p>
        </div>
        <div className="flex md:hidden flex-col gap-4">
          ...
          <p className="font-adobe text-black text-sm leading-relaxed">
            En las <strong>empresas de servicios básicos</strong>, cada factura depende de contratos
            complejos, mediciones, validaciones operativas y procesos internos del cliente. Sena ordena y
            acelera tu ciclo de cuentas por cobrar B2B.
          </p>
