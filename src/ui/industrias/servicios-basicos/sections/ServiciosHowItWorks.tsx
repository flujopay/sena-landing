...
const steps = [
  {
    ...
    label: '1. Prepara',
    description:
      'Importa facturas desde tu ERP o mediante carga masiva. Organiza por cliente, contrato, servicio, período, SLA, monto y vencimiento.',
    icon: (
  ...
  },
  {
    ...
    label: '2. Cobra',
    description:
      'Activa secuencias automáticas de cobranza adaptadas a cada tipo de cliente B2B de servicios básicos.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M22 2L11 13"
  ...
  },
  {
    ...
    label: '3. Evalúa',
    description:
      'Monitorea en tiempo real respuestas, avances y bloqueos operativos o técnicos que afectan el pago de cada factura.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
