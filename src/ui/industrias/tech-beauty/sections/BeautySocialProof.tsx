          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-slate-700 text-base md:text-lg leading-relaxed italic">
                Antes dedicábamos 3 días al mes solo a perseguir pagos de salones. Con Sena, la cobranza corre sola y solo intervenimos en casos puntuales. Recuperamos el 28% más en los primeros 90 días.
              </p>
              <div className="mt-4">
                ...
                <p className="text-slate-500 text-sm">
                  Empresa de distribución de cosmética profesional
                </p>
              </div>
            </div>
          </div>
