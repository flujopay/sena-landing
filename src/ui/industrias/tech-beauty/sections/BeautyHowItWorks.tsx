...
const steps = [
  {
    ...
    title: "Prepara",
    description:
      "Importa tus facturas y clientes. Ordena montos, vencimientos y contactos automáticamente.",
    icon: (
  ...
  },
  {
    ...
    title: "Cobra",
    description:
      "Activa secuencias multicanal inteligentes. WhatsApp, email y SMS con el tono de tu marca.",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    title: "Evalúa",
    description:
      "Mide qué funciona. Métricas de apertura, respuesta y conversión por canal y segmento.",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    title: "Recupera",
    description:
      "Para casos complejos, nuestro equipo humano interviene con criterio y experiencia.",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    title: "Concilia",
    description:
      "Pagos registrados automáticamente. Cierre de facturas sin trabajo manual.",
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const BeautyHowItWorks = () => {
  const [activeIndex, setActiveIndex] = useState(0);
  const active = steps[activeIndex];

  return (
    <section id="beauty-como-funciona" className="py-16 md:py-24">
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        ...
        <div className="md:hidden flex flex-col gap-4">
          {steps.map((s) => (
            <div
              key={s.key}
              className="bg-[#F9F9F9] rounded-2xl p-5 border border-slate-100"
            >
