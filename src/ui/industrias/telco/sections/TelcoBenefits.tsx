export const TelcoBenefits = () => {
  const benefits = [
    {
      title: "Cobranza que respeta la relación comercial",
      description:
        "Gestiones profesionales que cuidan el vínculo con tus clientes estratégicos, sin poner en riesgo renovaciones ni contratos activos.",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 21.35L10.55 20.03C5.4 15.36 2 12.28 2 8.5C2 5.42 4.42 3 7.5 3C9.24 3 10.91 3.81 12 5.09C13.09 3.81 14.76 3 16.5 3C19.58 3 22 5.42 22 8.5C22 12.28 18.6 15.36 13.45 20.04L12 21.35Z" stroke="currentColor" strokeWidth="1.8" />
        </svg>
      ),
    },
    {
      ...
      description:
        "Organiza tus cuentas por cobrar por contrato, servicio, SLA o proyecto para una visibilidad granular de cada factura.",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: "Seguimiento prioritario de facturas críticas",
      description:
        "Identifica y prioriza automáticamente las facturas de mayor impacto en tu flujo de caja para una gestión focalizada.",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: "Adaptación a SLAs y validaciones técnicas",
      description:
        "Configura flujos de cobranza que contemplan actas de conformidad, penalidades y validaciones técnicas propias de telecomunicaciones.",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M16 3.12602C17.7252 3.57006 19 5.13616 19 7C19 8.86384 17.7252 10.4299 16 10.874" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
        </svg>
      ),
    },
  ];
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        <div className="text-left mb-12">
          <p className="text-brand-primary-dark text-2xl sm:text-4xl font-extrabold leading-tight">
            Diseñado para la realidad del
            <br />
            <span className="text-brand-primary">negocio de telecomunicaciones</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {benefits.map((benefit) => (
            <div
              key={benefit.title}
              className="bg-white rounded-2xl p-6 border border-slate-100 hover:shadow-md transition-shadow duration-300"
            >
              <div className="w-10 h-10 rounded-full bg-brand-secondary-dark flex items-center justify-center text-white mb-4">
                {benefit.icon}
              </div>
              <h3 className="text-brand-primary-dark font-extrabold text-base mb-2">
                {benefit.title}
              </h3>
