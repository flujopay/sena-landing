export const AutopistasSocialProof = () => {
  const clientTypes = ["Concesionarias viales", "Operadores de autopistas urbanas e interurbanas", "Infraestructura de peajes", "Administradores de TAG", "Operadores de servicios de tránsito"];
  const metrics = [
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        ...
        <div className="bg-white rounded-2xl p-6 md:p-10 mb-12 border border-slate-100">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-slate-700 text-base md:text-lg leading-relaxed italic">Gestionábamos contratos B2B con grandes flotas y altos niveles de disputa por respaldo de tránsitos. Con Sena ordenamos la cobranza y recuperamos el 35% de la cartera vencida sin afectar la relación con nuestros clientes empresa.</p>
              <div className="mt-4">
