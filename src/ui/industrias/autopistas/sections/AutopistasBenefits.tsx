export const AutopistasBenefits = () => {
  const benefits = [
    {
      title: 'Reducción de disputas por conciliación de TAG',
      description:
        'Minimiza rechazos y reclamos con respaldo detallado de tránsitos y patentes asociadas a cada factura.',
      icon: (
    ...
    {
      title: 'Conciliación masiva de tránsitos',
      description:
        'Procesa y concilia miles de tránsitos para grandes flotas empresariales de forma automática y sin errores.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      title: 'Portales de autogestión para clientes empresa',
      description:
        'Tus clientes acceden a estados de cuenta, descargan respaldos de tránsitos y gestionan pagos de forma autónoma.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      title: 'Reportería ejecutiva por tramo y concesión',
      description:
        'Dashboards con DSO, aging y proyección de flujo segmentados por tramo, concesión o tipo de flota.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    },
    {
      ...
      description:
        'Equipo humano especializado en cobranza B2B de alto volumen para intervenir en negociaciones con grandes flotas y corporativos.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
