...
const steps = [
  {
    ...
    label: '1. Conecta',
    description:
      'Sincroniza datos de tránsitos, TAGs y facturación desde ERP o sistemas de billing para identificar saldos pendientes.',
    icon: (
  ...
  },
  {
    ...
    label: '2. Segmenta',
    description:
      'Agrupa clientes empresa por volumen de uso, tipo de flota, riesgo crediticio o antigüedad de la deuda.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M22 2L11 13"
  ...
  },
  {
    ...
    label: '3. Notifica',
    description:
      'Activa secuencias inteligentes de cobranza que incluyen el detalle completo de tránsitos y respaldos asociados.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    label: '4. Negocia',
    description:
      'Para montos críticos o disputas complejas, el equipo especialista de Sena interviene con estrategia de negociación B2B.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
