...
const steps = [
  { key: "conecta", label: "1. Conecta", description: "Sincroniza datos de tránsitos, TAGs y facturación desde ERP o sistemas de billing para identificar saldos pendientes.", icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14 2H6C4.89543 2 4 2.89543 4 4V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V8L14 2Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" /><path d="M14 2V8H20" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" /><path d="M12 18V12" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /><path d="M9 15L12 12L15 15" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>) },
  { key: "segmenta", label: "2. Segmenta", description: "Agrupa clientes empresa por volumen de uso, tipo de flota, riesgo crediticio o antigüedad de la deuda.", icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M22 2L11 13" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /><path d="M22 2L15 22L11 13L2 9L22 2Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" /></svg>) },
  { key: "notifica", label: "3. Notifica", description: "Activa secuencias inteligentes de cobranza que incluyen el detalle completo de tránsitos y respaldos asociados.", icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 20V10" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /><path d="M12 20V4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /><path d="M6 20V14" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg>) },
  { key: "negocia", label: "4. Negocia", description: "Para montos críticos o disputas complejas, el equipo especialista de Sena interviene con estrategia de negociación B2B.", icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 12.5C9.93 12.5 8.25 10.82 8.25 8.75C8.25 6.68 9.93 5 12 5C14.07 5 15.75 6.68 15.75 8.75C15.75 10.82 14.07 12.5 12 12.5Z" stroke="currentColor" strokeWidth="1.8" /><path d="M6.5 19C6.5 15.96 8.96 13.5 12 13.5C15.04 13.5 17.5 15.96 17.5 19" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg>) },
  { key: "concilia", label: "5. Concilia", description: "Pagos registrados automáticamente. Cierre de facturas y conciliación sin reprocesos manuales.", icon: (<svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 11L12 14L22 4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /><path d="M21 12V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V5C3 3.89543 3.89543 3 5 3H16" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg>) },
];

export const AutopistasHowItWorks = () => {
  const [activeIndex, setActiveIndex] = useState(0);
  const active = steps[activeIndex];

  return (
    <section id="auto-como-funciona" className="py-16 md:py-24">
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        <div className="text-left mb-12">
          <p className="text-brand-primary-dark text-2xl sm:text-4xl font-extrabold leading-tight">
            Tu ciclo de cobranza B2B<br />
            <span className="text-brand-primary">en autopistas, en 5 pasos</span>
          </p>
        </div>
