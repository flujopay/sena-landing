export const AutopistasWhySena = () => {
  const differentiators = [
    {
      title: 'Entendemos la complejidad operativa de la cobranza en autopistas',
      description:
        'Conocemos los desafíos de conciliación de TAG, gestión de flotas y la dinámica de contratos con grandes corporativos del sector vial.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Automatización inteligente para el volumen masivo de tránsitos, intervención humana especializada para disputas y negociaciones complejas.',
    },
  ]
