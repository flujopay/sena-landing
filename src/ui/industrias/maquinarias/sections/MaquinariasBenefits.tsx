  ...
  const benefits = [
    {
      ...
      description:
        'Tus clientes son socios de largo plazo. Sena cobra con criterio, preservando el vínculo que construiste en años de trabajo conjunto.',
      icon: (
    ...
    },
    {
      ...
      description:
        'Visualiza cuentas por cobrar segmentadas por faena, contrato o cliente. Ideal para operaciones con múltiples frentes simultáneos.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      title: 'Seguimiento de facturas de alto valor',
      description:
        'Alertas y escalamientos automáticos para facturas críticas. Sabes exactamente qué está pasando con cada cobro importante.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      title: 'Gestión de pagos parciales y retenciones',
      description:
        'La industria tiene sus particularidades: anticipos, estados de pago, retenciones por garantía. Sena se adapta a tu realidad.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      title: 'Reportería para dirección y finanzas',
      description:
        'Dashboards ejecutivos con DSO, aging, proyección de flujo. La información que necesitas para tomar decisiones, sin armarla a mano.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      title: 'Respaldo para casos complejos',
      description:
        'Cuando la automatización no alcanza, nuestro equipo de Recsa —con presencia en 15 países— toma el caso con la seriedad que requiere.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
