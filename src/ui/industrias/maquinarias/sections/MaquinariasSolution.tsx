export const MaquinariasSolution = () => {
  const pillars = [
    {
      title: "Centraliza",
      description: "Todas tus cuentas por cobrar en un solo lugar. Por cliente, proyecto, obra o contrato. Visibilidad total sin depender de Excel.",
    ...
    {
      title: "Automatiza",
      description: "Secuencias de cobranza profesionales y personalizables. Recordatorios que llegan en el momento justo, por el canal correcto, con el tono adecuado.",
      icon: (<svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L14.2 7.8L20 10L14.2 12.2L12 18L9.8 12.2L4 10L9.8 7.8L12 2Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" /><path d="M19 14L19.8 16.2L22 17L19.8 17.8L19 20L18.2 17.8L16 17L18.2 16.2L19 14Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" /></svg>),
    },
    {
      title: "Recupera",
      description: "Para facturas complejas o clientes difíciles, nuestro equipo de especialistas interviene. 40+ años de experiencia en recuperación B2B de alto valor.",
      icon: (<svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 12.5C9.93 12.5 8.25 10.82 8.25 8.75C8.25 6.68 9.93 5 12 5C14.07 5 15.75 6.68 15.75 8.75C15.75 10.82 14.07 12.5 12 12.5Z" stroke="currentColor" strokeWidth="1.8" /><path d="M6.5 19C6.5 15.96 8.96 13.5 12 13.5C15.04 13.5 17.5 15.96 17.5 19" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg>),
    },
  ];
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        <div className="text-left mb-4">
          <p className="text-brand-primary-dark text-2xl sm:text-4xl font-extrabold leading-tight">
            ...
            <span className="text-brand-primary">bien</span>
          </p>
        </div>
        <p className="text-slate-600 text-base md:text-lg max-w-2xl mb-12 leading-relaxed">
          Una plataforma que entiende la cobranza de alto valor. Automatización inteligente + respaldo humano experto para cuando las cosas se ponen complejas.
        </p>
