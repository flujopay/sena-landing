  ...
  const pillars = [
    {
      title: 'Centraliza',
      description:
        'Todas tus cuentas por cobrar en un solo lugar. Por cliente, proyecto, obra o contrato. Visibilidad total sin depender de Excel.',
      icon: (
    ...
    },
    {
      title: 'Automatiza',
      description:
        'Secuencias de cobranza profesionales y personalizables. Recordatorios que llegan en el momento justo, por el canal correcto, con el tono adecuado.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      title: 'Recupera',
      description:
        'Para facturas complejas o clientes difíciles, nuestro equipo de especialistas interviene. 40+ años de experiencia en recuperación B2B de alto valor.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <section className="bg-[#F9F9F9] py-16 md:py-24">
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        ...
        <p className="text-slate-600 text-base md:text-lg max-w-2xl mb-12 leading-relaxed">
          Una plataforma que entiende la cobranza de alto valor. Automatización inteligente + respaldo humano
          experto para cuando las cosas se ponen complejas.
        </p>
