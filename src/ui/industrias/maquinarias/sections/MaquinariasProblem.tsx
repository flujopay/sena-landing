export const MaquinariasProblem = () => {
  const painPoints = [
    {
      number: '01',
      title: 'Ciclos de pago eternos',
      description:
        'Mineras y constructoras tienen procesos internos complejos. Una factura puede tardar 60, 90 o más días en pagarse. Y mientras tanto, tu flujo de caja sufre.',
    },
    {
      number: '02',
      title: 'Pocas facturas, mucho en juego',
      description:
        'No son miles de transacciones pequeñas. Son pocas operaciones de alto valor donde cada día de mora impacta directamente tu capital de trabajo.',
    },
    {
      number: '03',
      title: 'Relaciones que no puedes dañar',
      description:
        'Tus clientes son contratos de años. Presionar mal puede costarte la renovación. Pero no cobrar tampoco es opción.',
    },
  ]
