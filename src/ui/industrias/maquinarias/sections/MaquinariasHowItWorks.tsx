...
const steps = [
  {
    ...
    label: '1. Prepara',
    description:
      'Importa facturas desde tu ERP o carga masiva. Organiza por cliente, proyecto, monto y vencimiento.',
    icon: (
  ...
  },
  {
    ...
    label: '2. Cobra',
    description:
      'Activa secuencias automáticas adaptadas a cada tipo de cliente. Desde recordatorios suaves hasta escalamientos formales.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M22 2L11 13"
  ...
  },
  {
    ...
    label: '3. Evalúa',
    description:
      'Monitorea en tiempo real: quién abrió, quién respondió, qué facturas avanzan y cuáles necesitan atención.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    label: '4. Recupera',
    description:
      'Para casos críticos o montos altos, nuestro equipo de especialistas interviene con estrategia de negociación B2B.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  },
  {
    ...
    label: '5. Concilia',
    description:
      'Pagos registrados automáticamente. Cierre de facturas y estados de pago sin reconciliación manual.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M9 11L12 14L22 4"
