export const MaquinariasSocialProof = () => {
  const clientTypes = [
    ...
    'Empresas de arriendo de maquinaria',
    'Proveedores de servicios mineros',
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-slate-700 text-base md:text-lg leading-relaxed italic">
                Teníamos $2M USD en cartera vencida con clientes mineros. Con Sena recuperamos el 45% en 120
                días, sin perder un solo contrato. El equipo de recuperación entiende cómo negociar con
