export const MaquinariasWhySena = () => {
  const differentiators = [
    { title: "Entendemos la cobranza B2B de alto valor", description: "No es lo mismo cobrar $50 a un consumidor que $500,000 a una minera. Nuestra metodología está diseñada para operaciones donde cada factura importa." },
    { title: "Equipo con experiencia en el sector", description: "Recsa, nuestra empresa matriz, lleva décadas trabajando con industrias de equipamiento, construcción y minería en toda Latinoamérica." },
    { title: "Tecnología + criterio humano", description: "La automatización hace el trabajo repetitivo. El juicio experto entra cuando se necesita negociar, escalar o tomar decisiones delicadas." },
  ];
