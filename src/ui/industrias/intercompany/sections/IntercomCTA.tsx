...
export const IntercomCTA = () => {
  ...
  const trustElements = [
    ...
    {
      text: 'Integración con plataformas de facturación y CRM',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      text: 'Recuperación desde el primer ciclo de facturación',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <section className="bg-[#F9F9F9] py-16 md:py-24">
      <div className="max-w-[1280px] mx-auto px-4 md:px-10 text-center">
        <h2 className="text-brand-primary-dark text-3xl md:text-5xl font-extrabold leading-tight mb-4">
          Protege tu MRR y recupera ingresos
          <br className="hidden md:block" /> <span className="text-brand-primary">que ya son tuyos</span>
        </h2>
        <p className="text-slate-600 text-base md:text-lg max-w-2xl mx-auto mb-8 leading-relaxed">
          Agenda una demo de 30 minutos y descubre cómo Sena transforma la recuperación de pagos y la gestión
          de cobranza en empresas de suscripción y modelos de ingresos recurrentes.
        </p>
