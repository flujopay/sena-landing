export const IntercomSocialProof = () => {
  const clientTypes = [
    ...
    'Marketplaces con membresías',
    'Negocios de licencias y contratos anuales',
    'Empresas con modelo Intercompany',
  ]
  const metrics = [
    ...
    { value: '100%', label: 'Trazabilidad de gestión por cliente, plan y ciclo de facturación' },
  ]
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        <div className="text-left mb-12">
          <p className="text-brand-primary-dark text-2xl sm:text-4xl font-extrabold leading-tight">
            ...
            <br />
            <span className="text-brand-primary">que recuperan MRR con Sena</span>
          </p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-slate-700 text-base md:text-lg leading-relaxed italic">
                Teníamos un porcentaje importante de pagos fallidos que gestionábamos manualmente. Con Sena
                automatizamos la recuperación, redujimos el churn financiero y ahora tenemos visibilidad real
                de qué parte de nuestro MRR está en riesgo cada mes.
              </p>
              <div className="mt-4">
                <p className="text-brand-primary-dark font-bold text-sm">Head of Revenue</p>
                <p className="text-slate-500 text-sm">Plataforma SaaS B2B</p>
              </div>
            </div>
          </div>
        </div>
