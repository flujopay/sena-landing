      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        ...
        <div className="bg-white rounded-2xl p-6 md:p-10 mb-12 border border-slate-100">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-slate-700 text-base md:text-lg leading-relaxed italic">Teníamos un porcentaje importante de pagos fallidos que gestionábamos manualmente. Con Sena automatizamos la recuperación, redujimos el churn financiero y ahora tenemos visibilidad real de qué parte de nuestro MRR está en riesgo cada mes.</p>
              <div className="mt-4">
