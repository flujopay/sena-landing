...
const steps = [
  {
    ...
    label: '1. Conecta',
    description:
      'Integra tu plataforma de facturación, CRM o sistema de suscripciones para sincronizar la cartera de cuentas por cobrar en tiempo real.',
    icon: (
  ...
  },
  {
    ...
    label: '2. Segmenta',
    description:
      'Clasifica cuentas por plan, monto, antigüedad y riesgo de churn. Define prioridades de recuperación según el impacto en tu MRR.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M22 2L11 13"
  ...
  },
  {
    ...
    label: '3. Notifica',
    description:
      'Automatiza secuencias de recuperación: recordatorios previos al vencimiento, alertas de pago fallido y mensajes de seguimiento con tono adecuado a cada tipo de cliente.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    label: '4. Gestiona',
    description:
      'Centraliza el seguimiento de cada caso: intentos de cobro, respuestas, acuerdos de pago, pausas de servicio y documentación formal.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  },
  {
    ...
    label: '5. Recupera',
    description:
      'Pagos conciliados automáticamente con tu sistema de facturación. Para casos críticos, Sena activa gestión especializada para cerrar el ciclo sin perder la relación.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M9 11L12 14L22 4"
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        <div className="text-left mb-12">
          <p className="text-brand-primary-dark text-2xl sm:text-4xl font-extrabold leading-tight">
            Tu ciclo de recuperación de ingresos
            <br />
              ...
              <button
                ...
                className={
                  idx === activeIndex
                    ...
                    : 'shrink-0 px-6 py-3 rounded-full text-brand-primary-dark font-extrabold text-lg tracking-wide cursor-pointer hover:bg-slate-100 transition-colors'
                }
              >
                {s.label}
              </button>
