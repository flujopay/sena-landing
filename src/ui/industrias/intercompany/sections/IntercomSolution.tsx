  ...
  const pillars = [
    {
      title: 'Centraliza',
      description:
        'Consolida todas las cuentas por cobrar de tu base de suscriptores o clientes de contrato en un solo lugar. Visibilidad por plan, ciclo de facturación, antigüedad y riesgo de churn — sin depender de planillas ni reportes manuales.',
      icon: (
    ...
    },
    {
      title: 'Automatiza',
      description:
        'Configura flujos de recuperación por tipo de cliente, monto y criticidad: recordatorios automáticos, reintentos de cobro, notificaciones escaladas y estados de cuenta formales. Todo personalizable según tu modelo comercial.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      title: 'Recupera',
      description:
        'Para cuentas de alto valor, contratos estratégicos o situaciones de riesgo comercial, el equipo especialista de Sena ejecuta cobranza con criterio, negociación B2B y cuidado de la relación con el cliente.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <section className="bg-[#F9F9F9] py-16 md:py-24">
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        ...
        <p className="text-slate-600 text-base md:text-lg max-w-2xl mb-12 leading-relaxed">
          Una plataforma especializada en recuperar pagos fallidos, gestionar cuentas vencidas y automatizar
          el ciclo de cobranza — con enfoque en proteger el MRR, reducir el churn financiero y mantener
