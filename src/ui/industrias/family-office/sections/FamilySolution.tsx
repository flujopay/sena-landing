  ...
  const pillars = [
    {
      title: 'Centraliza',
      description:
        'Consolida las cuentas por cobrar de todas tus sociedades y unidades de negocio en una sola plataforma. Visibilidad por empresa, cliente, proyecto, activo o rubro, con reporting ejecutivo sin depender de reportes manuales.',
      icon: (
    ...
    },
    {
      title: 'Automatiza',
      description:
        'Configura flujos de cobranza por tipo de cliente y nivel de relación (estratégico, recurrente, alto riesgo). Notificaciones, recordatorios y seguimiento con respaldo formal, manteniendo orden y consistencia.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      title: 'Recupera',
      description:
        'Para cuentas sensibles, montos altos o clientes complejos, el equipo especialista de Sena ejecuta cobranza con criterio, estrategia y negociación B2B, cuidando la reputación y relación comercial del grupo.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        <div className="text-left mb-4">
          <p className="text-brand-primary-dark text-2xl sm:text-4xl font-extrabold leading-tight">
            Sena: Control financiero centralizado
            <br />
        ...
        <p className="text-slate-600 text-base md:text-lg max-w-2xl mb-12 leading-relaxed">
          Una plataforma diseñada para consolidar la cobranza y el seguimiento de cuentas por cobrar en
          holdings, empresas familiares y vehículos de inversión, combinando automatización inteligente con
          ejecución experta.
        </p>
