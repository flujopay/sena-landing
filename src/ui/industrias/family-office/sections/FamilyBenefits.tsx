export const FamilyBenefits = () => {
  const benefits = [
    {
      title: 'Visibilidad consolidada de cartera',
      description:
        'Ve todas las cuentas por cobrar por empresa, rubro o sociedad en un solo dashboard ejecutivo.',
      icon: (
    ...
    },
    {
      ...
      description:
        'Compara cobros esperados vs. realidad para anticipar brechas de liquidez antes de que se conviertan en urgencias.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      ...
      description:
        'Notificaciones automáticas sobre montos relevantes y atrasos que requieren atención inmediata del equipo financiero.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      ...
      description:
        'Cada gestión queda registrada con responsable, fecha y resultado. Trazabilidad total para auditorías y toma de decisiones.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      ...
      description:
        'Clasifica clientes según riesgo, relación estratégica y monto para aplicar estrategias de cobranza diferenciadas.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      title: 'Ejecución experta para casos sensibles',
      description:
        'Equipo especializado en cobranza B2B de alto impacto para montos altos y clientes que requieren negociación con criterio.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
