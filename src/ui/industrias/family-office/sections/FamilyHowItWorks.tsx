...
const steps = [
  {
    ...
    label: '1. Conecta',
    description:
      'Integra tus fuentes de facturación, ERP o sistemas contables para consolidar las cuentas por cobrar de cada sociedad del grupo.',
    icon: (
  ...
  },
  {
    ...
    label: '2. Ordena',
    description:
      'Clasifica cartera por empresa, cliente, tipo de servicio, activo o proyecto. Define prioridades según monto, antigüedad o riesgo.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M22 2L11 13"
  ...
  },
  {
    ...
    label: '3. Notifica',
    description:
      'Automatiza recordatorios y estados de cuenta con un tono profesional, formal y consistente para cada tipo de relación comercial.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    label: '4. Gestiona',
    description:
      'Centraliza el seguimiento de cada caso: contactos, respuestas, acuerdos, promesas de pago y documentación respaldatoria.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  },
  {
    ...
    label: '5. Recupera',
    description:
      'Pagos conciliados automáticamente. Para casos críticos, Sena interviene con gestión especializada y cierre formal del ciclo de cobranza.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M9 11L12 14L22 4"
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        <div className="text-left mb-12">
          <p className="text-brand-primary-dark text-2xl sm:text-4xl font-extrabold leading-tight">
            Tu ciclo de cobranza patrimonial
            <br />
