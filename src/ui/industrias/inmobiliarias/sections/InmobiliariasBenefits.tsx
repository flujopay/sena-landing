  ...
  const benefits = [
    {
      ...
      description:
        'Ve todas las cuentas por cobrar segmentadas por proyecto, unidad o sociedad en un solo dashboard ejecutivo.',
      icon: (
    ...
    {
      title: 'Control automático de vencimientos y cuotas',
      description:
        'Alertas automáticas sobre cuotas próximas a vencer y atrasos que requieren atención inmediata del equipo financiero.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      title: 'Reducción de morosidad en arriendos y promesas',
      description:
        'Secuencias de cobranza automatizadas que actúan antes de que los atrasos se acumulen y afecten el flujo de caja.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      title: 'Seguimiento con historial y trazabilidad formal',
      description:
        'Cada gestión queda registrada con responsable, fecha y resultado. Trazabilidad completa para auditorías y decisiones.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      title: 'Reportería ejecutiva de DSO y riesgo de cartera',
      description:
        'Dashboards con aging, DSO y proyección de flujo para la toma de decisiones de inversión y continuidad de obra.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      title: 'Cobranza especializada para montos altos',
      description:
        'Equipo experto en cobranza B2B para casos judicializables o montos altos que requieren gestión profesional y respaldo documental.',
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        <div className="text-left mb-12">
          <p className="text-brand-primary-dark text-2xl sm:text-4xl font-extrabold leading-tight">
            Diseñado para proyectos, cuotas
            <br />
