  ...
  const pillars = [
    {
      title: 'Centraliza',
      description:
        'Consolida todas las cuentas por cobrar en una sola plataforma: por proyecto, cliente, unidad, sociedad o tipo de contrato. Visibilidad completa sin depender de múltiples reportes internos.',
      icon: (
    ...
    },
    {
      title: 'Automatiza',
      description:
        'Notificaciones automáticas, recordatorios por vencimiento, estados de cuenta claros y seguimiento estructurado para cuotas inmobiliarias, arriendos y pagos periódicos.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      title: 'Recupera',
      description:
        'Cuando hay morosidad crítica o casos sensibles, el equipo especialista de Sena interviene con gestión profesional y respaldo documental, priorizando montos relevantes sin dañar la reputación de la inmobiliaria.',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10">
        <div className="text-left mb-4">
          <p className="text-brand-primary-dark text-2xl sm:text-4xl font-extrabold leading-tight">
            Sena: Control total de la cobranza inmobiliaria,
            <br />
        ...
        <p className="text-slate-600 text-base md:text-lg max-w-2xl mb-12 leading-relaxed">
          Una plataforma diseñada para administrar carteras inmobiliarias complejas: cuotas, arriendos, gastos
          comunes y pagos asociados a contratos, con automatización inteligente y gestión experta.
        </p>
