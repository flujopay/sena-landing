      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-10 py-16 md:py-24">
        <div className="hidden md:flex flex-col gap-6 max-w-3xl">
          ...
          <p className="font-adobe text-black text-xl max-w-2xl leading-relaxed">
            En una inmobiliaria, vender es solo el inicio: el verdadero desafío es cobrar en tiempo, controlar
            cuotas, gestionar promesas, evitar morosidad y mantener visibilidad real del flujo.{' '}
            <strong>Sena centraliza tu cartera, automatiza la cobranza y acelera el ciclo de pago</strong>{' '}
            para que cada unidad vendida o arrendada se transforme en liquidez real.
          </p>
          <div className="flex flex-row items-start gap-3 mt-2">
            ...
            <Button
              ...
              className="text-lg"
              onClick={() => {
                const el = document.getElementById('inmob-como-funciona')
                if (el) el.scrollIntoView({ behavior: 'smooth', block: 'start' })
              }}
            />
          </div>
          <p className="text-slate-500 text-sm mt-2">
            Inmobiliarias y administradoras de activos ya confían en Sena.
          </p>
        </div>
        <div className="flex md:hidden flex-col gap-4">
          ...
          <p className="font-adobe text-black text-sm leading-relaxed">
            En una inmobiliaria, vender es solo el inicio.{' '}
            <strong>Sena centraliza tu cartera, automatiza la cobranza y acelera el ciclo de pago</strong>{' '}
            para que cada unidad vendida o arrendada se transforme en liquidez real.
          </p>
