...
const steps = [
  {
    ...
    label: '1. Conecta',
    description:
      'Integra facturación, ERP, sistema contable o planillas existentes para importar cartera por proyecto o unidad.',
    icon: (
  ...
  },
  {
    ...
    label: '2. Ordena',
    description:
      'Clasifica cuentas por cobrar por proyecto, torre, unidad, cliente o tipo de pago (cuotas, arriendo, gastos comunes).',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M22 2L11 13"
  ...
  },
  {
    ...
    label: '3. Notifica',
    description:
      'Automatiza recordatorios previos al vencimiento, alertas por atraso y envío de estados de cuenta con detalle claro.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    label: '4. Gestiona',
    description:
      'Registra toda la interacción: acuerdos, compromisos de pago, documentación y responsables internos.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
  ...
  },
  {
    ...
    label: '5. Recupera',
    description:
      'Pagos conciliados automáticamente. Para atrasos críticos, Sena ejecuta cobranza especializada y cierre de casos con trazabilidad completa.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M9 11L12 14L22 4"
