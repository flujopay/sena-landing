export const InmobiliariasSocialProof = () => {
  const clientTypes = [
    'Inmobiliarias',
    'Constructoras con venta directa',
    'Administradoras de arriendo',
    'Gestores de proyectos inmobiliarios',
    'Empresas de renta residencial y comercial',
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-slate-700 text-base md:text-lg leading-relaxed italic">
                Teníamos múltiples proyectos activos y el seguimiento de cuotas dependía de planillas. Con
                Sena consolidamos la cartera, automatizamos recordatorios y bajamos la morosidad sin aumentar
