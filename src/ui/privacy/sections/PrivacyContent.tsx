        ...
        <section className="bg-white text-slate-700 font-normal text-sm md:text-base p-8 md:p-14 rounded-2xl shadow-sm space-y-8">
          ...
          <div>
            ...
            <p className="leading-relaxed">
              La presente Política de Privacidad (junto con los Términos y Condiciones del servicio) tiene por
              finalidad informar a los usuarios sobre el tratamiento de los datos personales que se recogen,
              publican, procesan e intercambian a través de la plataforma y servicios de SERVICIOS DE
              TECNOLOGÍA FLUJOLINK SpA (en adelante, "Sena"), en cumplimiento con la legislación vigente en
              Chile y demás normativa aplicable.
            </p>
            ...
            <p className="leading-relaxed mt-3">
              ...
              utilizar los datos personales de acuerdo a la finalidad de los servicios descritos en esta
              Política.
            </p>
          </div>
          ...
          <div>
            <h2 className="text-brand-primary-dark text-xl md:text-2xl font-bold mb-3">
              2. Responsable del Tratamiento
            </h2>
          ...
          <div>
            ...
            <p className="leading-relaxed mb-3">
              Sena puede recopilar y tratar las siguientes categorías de datos personales:
            </p>

            <h3 className="text-brand-primary-dark text-base md:text-lg font-semibold mb-2 mt-4">
            ...
            <h3 className="text-brand-primary-dark text-base md:text-lg font-semibold mb-2 mt-4">
              3.2 Datos contractuales y operativos
            </h3>
            <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <h3 className="text-brand-primary-dark text-base md:text-lg font-semibold mb-2 mt-4">
              3.4 Datos provenientes de terceros
            </h3>
          ...
          <div>
            ...
            <p className="leading-relaxed mb-3">
              Los datos personales proporcionados por las diferentes fuentes de información y procesos de
              registro y autenticación tienen por objeto identificar al Usuario, y serán utilizados
              exclusivamente para los fines que fueron suministrados, incluyendo:
            </p>
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li>Identificar a usuarios y clientes</li>
              <li>Gestionar procesos de cobranza y cuentas por cobrar/pagar</li>
              <li>
                Automatizar recordatorios y comunicaciones multicanal (WhatsApp, correo electrónico, SMS)
              </li>
            ...
            <p className="leading-relaxed mt-3">
              Sena no utilizará los datos para fines distintos a los aquí señalados, salvo que provengan de
          ...
          <div>
            ...
            <p className="leading-relaxed mt-3">
              El Usuario autoriza expresamente a Sena para tratar sus datos conforme a las finalidades
          ...
          <div>
            ...
            <p className="leading-relaxed mb-3">
              Con la autorización del Usuario, Sena podrá comunicar los datos a sus empresas relacionadas (ej.
              Recsa) y/o a terceras personas que tengan directa relación con el servicio ofrecido, en los
              siguientes casos:
            </p>
            <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <li>
                Cuando intervengan proveedores tecnológicos que operen bajo acuerdos de confidencialidad
              </li>
            ...
            <p className="leading-relaxed mt-3">
              Los proveedores tecnológicos pueden incluir servicios de infraestructura cloud, mensajería y
              correo electrónico transaccional, todos ellos operando bajo estándares de seguridad adecuados y
              acuerdos de confidencialidad.
            </p>
            <p className="leading-relaxed mt-3">
              Sena no revelará los datos personales de los usuarios a terceros no autorizados. Si terceras
              partes se pusiesen en contacto con Sena solicitando datos de los usuarios, se les indicará que
              se comuniquen directamente con los respectivos usuarios, sin revelar información adicional de
              identificación o medios de contacto que no hayan sido previamente conocidos.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="leading-relaxed mt-3">
              Los datos recogidos podrán ser conservados y tratados con fines estadísticos, siempre y cuando
              sea imposible la identificación de sus titulares utilizando medios técnicos razonables.
            </p>
            <p className="leading-relaxed mt-3">
              Al término del contrato de servicios, los datos serán eliminados o devueltos de forma segura
              según los acuerdos contractuales aplicables.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li>
                <strong>Acceso:</strong> Conocer qué datos personales suyos están siendo tratados
              </li>
              <li>
                <strong>Rectificación:</strong> Solicitar la corrección de datos inexactos o incompletos
              </li>
              <li>
                <strong>Cancelación:</strong> Solicitar la supresión de sus datos cuando ya no sean necesarios
              </li>
              <li>
              ...
              <li>
                <strong>Eliminación:</strong> Solicitar la eliminación de datos registrados o publicados en la
                plataforma
              </li>
            </ul>
            <p className="leading-relaxed mt-3">
          ...
          <div>
            ...
            <p className="leading-relaxed">
              Dado que Sena utiliza infraestructura cloud internacional, algunos datos pueden ser almacenados
              en servidores fuera de Chile, garantizando siempre estándares adecuados de protección y
              seguridad conforme a la legislación aplicable.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="leading-relaxed mb-2">
              Sena puede utilizar cookies técnicas y analíticas estrictamente necesarias para:
            </p>
            <ul className="list-disc list-inside space-y-1 ml-4">
          ...
          <div>
            ...
            <p className="leading-relaxed">
              Sena se reserva el derecho de modificar la presente Política de Privacidad, con el objeto de
              adaptarla a cambios normativos o reglamentarios, a prácticas generales de la industria o a
              políticas internas propias de Sena.
            </p>
            <p className="leading-relaxed mt-3">
              Las modificaciones serán publicadas en el sitio web y entrarán en vigencia desde su publicación.
              Es obligación de los Usuarios revisar periódicamente las modificaciones o actualizaciones de la
          ...
          <div>
            ...
            <p className="leading-relaxed mb-2">
              Para cualquier consulta relacionada con esta Política de Privacidad o con el tratamiento de sus
              datos personales, puede comunicarse con nosotros a través de:
            </p>
            <p className="mt-2">
              Correo electrónico: <strong>hola@somossena.com</strong>
            </p>
            <p>
              Sitio web: <strong>www.somossena.com</strong>
            </p>
          </div>
        </section>
