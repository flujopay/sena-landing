    ...
    () => [
      {
        ...
        number: 1,
        title: '1. Prepara',
        subtitle: 'Tus facturas ordenadas en minutos.',
        description: 'Sube tu cartera y Sena estructura todo automáticamente: facturas, contactos y montos listos para cobrar.',
      ...
      },
      {
        ...
        number: 2,
        title: '2. Cobra',
        subtitle: 'La cobranza funciona sola.',
        description: 'Secuencias automáticas por WhatsApp, email y SMS según el vencimiento y comportamiento de cada cliente. Sin perseguir a nadie.',
      ...
      },
      {
        ...
        number: 4,
        title: '4. Recupera',
        subtitle: 'Cuando hace falta, entra el equipo experto.',
        description:
          'El equipo de Recsa gestiona los casos complejos cuidando tu marca y tu relación con el cliente. Más de 40 años haciendo exactamente eso.',
      },
      {
        ...
        number: 5,
        title: '5. Concilia',
        subtitle: 'El cierre de mes sin trabajo manual.',
        description: 'Los pagos se registran y concilian automáticamente. Sin Excel, sin errores, sin horas extra.',
              ...
              <div className="p-6 md:p-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    {activeKey === 'Recupera' ? (
                      ...
                      <>
                        <video
                          ...
                          playsInline
                        >
                          <source src={(active as any).video} type="video/mp4" />
                        </video>
                        <div className="absolute inset-0 bg-linear-to-t from-black/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                        <div className="hidden md:flex absolute inset-0 items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div className="flex flex-col gap-2">
                  <div className="bg-brand-primary text-white  rounded-full flex items-center gap-3 w-fit px-8 py-2">
                    <p className="text-sm md:text-xl font-bold tracking-wide">{active.title}</p>
                  </div>
                  <div>
                  ...
                  <p className="mt-2 text-black/95 leading-6 max-w-md">{active.description}</p>
