...
const Badge = ({ children, color = 'blue' }: { children: ReactNode; color?: BadgeColor }) => {
  ...
  return (
    <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-semibold ${map[color]}`}>
      {children}
    </span>
  )
}
...
const InfoBox = ({
  ...
  return (
    <div className={`flex gap-3 border-l-4 rounded-r-lg p-4 my-4 text-sm ${map[type]}`}>
...
const H4 = ({ children }: { children: ReactNode }) => (
  <h4 className="text-xs font-bold text-[#2270D0] uppercase tracking-wider mt-5 mb-2">{children}</h4>
)
...
const CardGrid = ({ items }: { items: { icon: string; title: string; desc: string }[] }) => (
...
const tocSections = [
  ...
  {
    label: 'Estado Global',
    items: ['7. Context API vs Zustand', '8. Contextos Principales', '9. Stores de Zustand'],
  },
  {
...
const sections = [
  {
    ...
    content: () => (
      <>
        ...
        <InfoBox type="note">
          El proyecto no utiliza librerías de UI genéricas como Material UI o Ant Design. Esto permite
          customizar cada componente de acuerdo a los requerimientos específicos del producto, aprovechando
          inteligencia artificial para acelerar la lógica de componentes comunes y dedicando el tiempo del
          equipo a la calidad visual de cada pieza.
        </InfoBox>
      </>
    ),
  },
    ...
    content: () => (
      <Table
        ...
        rows={[
          ...
          ['Peticiones HTTP', <Inline>Axios</Inline>, 'Comunicación con APIs con soporte de interceptores'],
          [
            'Estado remoto',
          ...
          ['Internacionalización', <Inline>i18n</Inline>, 'Traducciones por idioma y variante regional'],
        ]}
      />
    ),
  },
      ...
      <>
        ...
        <DocList
          items={[
            ...
            <span>
              Si ocurre un error <Inline>403</Inline>, limpia el almacenamiento local y redirige
              automáticamente al login.
            </span>,
            <span>
              Otros errores se propagan con <Inline>Promise.reject</Inline> para ser manejados
              individualmente.
            </span>,
          ]}
        />
      ...
      <>
        ...
        <Table
          ...
          rows={[
            ...
            [
              <Inline>icons/</Inline>,
              'SVGs exportados como componentes React',
              'Íconos de interfaz y acciones',
            ],
        ...
        />
        <InfoBox type="note">
          Los íconos no dependen de ninguna librería externa (FontAwesome, Heroicons, etc.). Esto garantiza
          control total sobre el set de íconos, tamaño del bundle y coherencia visual con el diseño de Sena.
        </InfoBox>
      </>
    ),
  },
      ...
      <>
        ...
        <PropsTable
          rows={[
            ...
            ['position', '{top,right,bottom,left}', 'Posición para modal flotante'],
            ['closeOnOutsideClick', 'boolean', 'Cierra al hacer clic fuera (default: true)'],
          ]}
        />
        ...
        <Table
          ...
          rows={[
            ...
            [<Inline>CustomSelect</Inline>, 'Selector base con opciones simples.', 'Filtros y configuración'],
            [<Inline>CustomMultipleSelect</Inline>, 'Selección múltiple.', 'Filtros avanzados'],
            [
        ...
        <Table
          ...
          rows={[
            [<Inline>ButtonActions</Inline>, 'Acciones por fila: editar, eliminar, ver detalle'],
            [<Inline>DateFilterTable</Inline>, 'Filtro por rango de fechas'],
            [<Inline>EditColumns</Inline>, 'Panel de columnas visibles/ocultas'],
            [<Inline>OrderDropdownTable</Inline>, 'Ordenamiento por columna'],
            [<Inline>Pagination</Inline>, 'Control de páginas y registros por página'],
            [<Inline>SendColumnsByEmail</Inline>, 'Envío de columnas por email'],
            [<Inline>StatusFilterTable</Inline>, 'Filtro por estado con valores predefinidos'],
            [<Inline>StringFilterTable</Inline>, 'Filtro de texto libre por columna'],
          ]}
        />
        ...
        <TwoCol
          left={
            <>
              ...
              />
              <p className="text-xs font-semibold text-yellow-700 mt-3 mb-1">Limitaciones</p>
              <DocList
                items={[
          ...
          right={
            <>
              ...
              />
              <p className="text-xs font-semibold text-yellow-700 mt-3 mb-1">Limitaciones</p>
              <DocList items={['Requiere dependencia externa', 'Menos integrado con el ciclo de React']} />
            </>
          }
        />
        <InfoBox type="note">
          La estrategia es migrar progresivamente los contextos más críticos hacia Zustand, de forma
          incremental y sin comprometer la estabilidad del sistema.
        </InfoBox>
      </>
    ),
  },
    ...
    content: () => (
      <>
        ...
        <Table
          ...
          rows={[
            [<Inline>list_countries / list_phone_code</Inline>, 'Listados de países y códigos telefónicos'],
            [<Inline>list_currencies / list_banks</Inline>, 'Monedas y bancos disponibles'],
            [<Inline>list_cost_centers</Inline>, 'Centros de costo de la empresa'],
            [<Inline>list_accounting_accounts</Inline>, 'Cuentas contables disponibles'],
            [<Inline>list_stage / list_sub_stage</Inline>, 'Etapas y subestapas de gestión'],
            [<Inline>configuration_company_json</Inline>, 'Configuración de empresa en JSON'],
            [<Inline>configuration_invoice_json</Inline>, 'Configuración de facturas emitidas'],
            [<Inline>configuration_invoice_received_json</Inline>, 'Configuración de facturas recibidas'],
            [<Inline>configuration_provider_json</Inline>, 'Configuración de proveedores'],
          ]}
        />
        ...
        <Table
          ...
          rows={[
            ['MenuItemsContext', 'Ítems del menú dinámicos según rol del usuario'],
            ['CurrencyContext', 'Moneda seleccionada (soles, dólares, pesos…)'],
            ['DashboardContext', 'Estado del panel principal y widgets visibles'],
            ['OnboardingContext', 'Avance y datos del proceso de onboarding'],
            ['WhatsappContext', 'Estado de conexión, mensajes y contactos WhatsApp'],
          ]}
        />
      </>
    ),
  },
  {
    ...
    content: () => (
      <Table
        ...
        rows={[
          [<Inline>crmStore</Inline>, 'Estado global del CRM', 'Clientes, conversaciones, mensajes, paneles'],
          [
          ...
          [<Inline>whatsappStore</Inline>, 'Integración WhatsApp', 'Conexión, mensajes, contactos'],
        ]}
      />
    ),
  },
      ...
      <>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 my-3">
          <ol className="space-y-2 text-sm text-gray-700 list-decimal list-inside">
            ...
            <li>Si es exitoso → se actualiza UserContext, se guardan tokens y se redirige.</li>
            <li>Si hay error → mensaje claro (credenciales incorrectas, usuario inactivo, etc.).</li>
          </ol>
        </div>
        ...
        <Table
          ...
          rows={[
            [<Inline>SignupComponent</Inline>, 'Registro estándar con campos básicos y validación'],
            [<Inline>SignupNewComponent</Inline>, 'Registro extendido multi-paso con UI dinámica'],
            [<Inline>CXCSignupComponent</Inline>, 'Registro específico para clientes del módulo de cobros'],
            [<Inline>CXPSignupComponent</Inline>, 'Registro específico para clientes del módulo de pagos'],
          ]}
        />
    ...
    content: () => (
      <>
        ...
        <Table
          ...
          rows={[
            ['📱 WhatsApp', 'Mensajería directa, gestión de contactos y estado de conexión'],
            ['📧 Email', 'Editor de bandeja, historial, panel de gestión'],
            ['💬 SMS', 'Envío y recepción de mensajes de texto'],
            ['📞 Llamadas', 'Panel, historial y gestión de contactos telefónicos'],
            ['🗨️ Chat interno', 'FlujoChat para comunicación interna del equipo'],
          ]}
        />
        <H3>13.2 Campañas</H3>
        <DocList
        ...
        <Table
          ...
          rows={[
            ['Automatizaciones', 'Configuración de procesos automáticos para reducir tareas manuales'],
            ['Flujos', 'Flujos configurables con ajustes de aprobaciones y nóminas'],
            ['Importaciones/Exportaciones', 'Gestión masiva de datos con exportaciones personalizadas'],
            ['Propiedades Personalizables', 'Campos y atributos adaptables por empresa'],
            ['Plantillas', 'Plantillas reutilizables para comunicaciones y procesos'],
          ]}
        />
      </>
    ),
    ...
    content: () => (
      <>
        <Table
          ...
          rows={[
            ['Empresa', 'Información básica, cuenta, marca (logo, colores) y procesos internos'],
            ['Cuentas Bancarias', 'Lista de cuentas con CRUD completo; reutilizado en aprobaciones y pagos'],
            ['Integraciones', 'SII (Chile), SUNAT (Perú), Google, Microsoft y Email'],
            ['Permisos y Roles', 'Usuarios, grupos, roles granulares y módulo de auditoría'],
            ['Suscripción', 'Plan actual, cambio de plan, método de pago y comprobantes'],
            ['Seguridad', 'Contraseñas, autenticación y parámetros de acceso'],
            ['Notificaciones', 'Preferencias de notificaciones de la aplicación'],
    ...
    content: () => (
      <Table
        ...
        rows={[
          ...
          ['🇨🇱 Chile', <Inline>es/CL/translation.json</Inline>, 'Adaptado al español chileno'],
          ['🇲🇽 México', <Inline>es/MX/translation.json</Inline>, 'Adaptado al español mexicano'],
          ['🇵🇪 Perú', <Inline>es/PE/translation.json</Inline>, 'Adaptado al español peruano'],
          ['🇺🇸 Inglés', <Inline>en/translation.json</Inline>, 'Soporte en inglés'],
        ]}
      />
    ),
  },
    ...
    content: () => (
      <Table
        ...
        rows={[
          ...
          [<Inline>formatDate</Inline>, 'Fechas con soporte UTC y zonas horarias usando dayjs.'],
          [<Inline>exportToExcel</Inline>, 'Exporta datos tabulares a .xlsx con columnas configurables.'],
          [<Inline>cn</Inline>, 'Combina clases CSS con clsx y tailwind-merge.'],
          [<Inline>timeAgo</Inline>, "Tiempo transcurrido: 'hace 2 días', 'hace 1 mes'."],
          [<Inline>capitalizePhrase</Inline>, 'Capitaliza frases respetando siglas y excepciones.'],
          [<Inline>generateUniqueCode</Inline>, 'Códigos únicos con prefijo, timestamp y número aleatorio.'],
          [<Inline>checkEmptyValue</Inline>, 'Retorna valor o cadena vacía si es null.'],
          [<Inline>scrollToContent</Inline>, 'Scroll a elemento con resaltado temporal.'],
          [<Inline>goBack / goForward</Inline>, 'Navegación en el historial del navegador.'],
        ]}
      />
    ),
  },
    ...
    content: () => (
      <>
        <Table
          ...
          rows={[
            [<Inline>example.spec.ts</Inline>, 'Referencia de estructura base para nuevos tests'],
            [
              <Inline>login.spec.ts</Inline>,
              'Credenciales válidas/inválidas, redirección y mensajes de error',
            ],
            [<Inline>signup.spec.ts</Inline>, 'Validación de campos, proceso exitoso y manejo de errores'],
          ]}
        />
        <InfoBox type="success">
          El plan es expandir progresivamente la cobertura hacia todos los flujos críticos, integrado en el
          pipeline de CI/CD.
        </InfoBox>
      </>
    ),
        ...
        <main className="flex-1 min-w-0 p-8 max-w-3xl">
          ...
          {active === 'intro' && (
            <div className="mb-8 rounded-2xl bg-linear-to-br from-gray-900 via-[#0f2a5e] to-gray-900 text-white p-8">
              ...
              <p className="text-blue-100 text-lg font-light mb-6">Frontend Documentation</p>
              <div className="flex gap-6 flex-wrap">
                {[
                  ...
                  <div key={l}>
                    <div className="text-xs text-blue-300 uppercase tracking-wider mb-0.5">{l}</div>
          ...
          <SectionHeader num={current.num} title={current.title} subtitle={current.subtitle} />
          <current.content />
