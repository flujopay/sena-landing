        ...
        <section className="bg-white text-slate-700 font-normal text-sm md:text-base p-8 md:p-14 rounded-2xl shadow-sm space-y-8">
          ...
          <div>
            ...
            <p className="leading-relaxed">
              ...
              <strong>Amazon Echo Show 5 (3.ª generación) color Negro</strong>, valorado en aproximadamente
              $69.990 CLP (precio referencial). El premio no es canjeable por dinero en efectivo ni por otros
              productos o servicios. Sena se reserva el derecho de reemplazar el premio por uno de igual o
              mayor valor en caso de indisponibilidad, comunicándolo oportunamente.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="leading-relaxed">
              ...
              complete el formulario de registro en <strong>demo.somossena.com</strong> proporcionando
              información verídica: nombre completo, empresa, cargo, correo electrónico corporativo y número
              de teléfono.
            </p>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1 leading-relaxed">
              <li>
                <strong>Inicio:</strong> miércoles 6 de mayo de 2026, desde las 09:00 hrs.
              </li>
              <li>
                <strong>Cierre:</strong> jueves 7 de mayo de 2026, a las 18:00 hrs.
              </li>
              <li>
                <strong>Sorteo:</strong> viernes 8 de mayo de 2026.
              </li>
            </ul>
            <p className="leading-relaxed mt-3">
          ...
          <div>
            ...
            <p className="leading-relaxed">
              El sorteo se realizará el viernes 8 de mayo de 2026 mediante selección aleatoria entre todos los
              participantes válidos registrados durante el período de participación. El proceso será
