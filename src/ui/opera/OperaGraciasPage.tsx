...
export const OperaGraciasPage = () => {
  ...
  useEffect(() => {
    ...
    if (window.gtag) window.gtag('event', 'completar_formulario', { product: 'opera' })
    ...
    <div className="min-h-screen bg-[#F9F9F9] flex flex-col">
      <div className="w-full py-6 flex justify-center">
        <button onClick={() => router.push('/')} className="cursor-pointer">
          <Image src={AssetImage.logoBlack} alt="Sena" className="w-36" priority />
        </button>
      </div>
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="bg-white rounded-3xl shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-slate-100 overflow-hidden mb-6">
            <div className="px-4 pt-6 pb-2 text-center">
              <p className="text-xs text-slate-400 font-medium mb-4">Agenda tu diagnóstico de 30 minutos</p>
            </div>
            <div
