...
const variantStyles: Record<ButtonVariant, string> = {
  primaryFilled: 'bg-brand-primary text-white hover:bg-brand-primary/90 focus:ring-brand-primary',

  primaryOutlined:
    'border border-3 border-brand-primary text-brand-primary hover:bg-brand-primary/10 focus:ring-brand-primary',

  primaryInvertedFilled: 'bg-white text-brand-primary hover:bg-white/90 focus:ring-white',
  ...
  secondaryFilled: 'bg-brand-secondary text-white hover:bg-brand-secondary/90 focus:ring-brand-secondary',
  ...
  (
    ...
    return (
      ...
      >
        ...
        {!loading && leftIcon}
        <span className={loading ? 'opacity-0' : 'opacity-100'}>{text ?? children}</span>
        {!loading && rightIcon}
      </button>
    )
  }
